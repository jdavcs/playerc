...
public abstract class Scanner
{
	...
	protected int getNextByte() throws IOException
	{
		...
		while (true)
		{
			...
			if (x == '\n') lineNumber++;
			if (x == -1) return -1;
			if (!isWhitespace((char)x)) return x;
		}
	}	
	...
	public boolean isNumericDigit(char c) { return ('0' <= c) && (c <= '9'); }	
	...
	protected char read() throws IOException { return (char)source.read(); }	
	
	protected void unread(char c) throws IOException { source.unread((int)c); }	
