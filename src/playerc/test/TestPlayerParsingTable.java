 ...
 * Created: Jul 22, 2005
 */
public class TestPlayerParsingTable extends TestCase
{
...
/*
      ...
      assertEquals(" make-body-marker  declarations-opt  make-declaration-list  'begin'  statements-opt  make-statement-list  'end'  make-body ", a53.toString());

      ParseAction a54 = table.lookup("body", "'var'");
      assertEquals(" make-body-marker  declarations-opt  make-declaration-list  'begin'  statements-opt  make-statement-list  'end'  make-body ", a54.toString());

      ParseAction a55 = table.lookup("body", "'type'");
      assertEquals(" make-body-marker  declarations-opt  make-declaration-list  'begin'  statements-opt  make-statement-list  'end'  make-body ", a55.toString());

      ParseAction a56 = table.lookup("body", "'procedure'");
      assertEquals(" make-body-marker  declarations-opt  make-declaration-list  'begin'  statements-opt  make-statement-list  'end'  make-body ", a56.toString());
      ...
      assertEquals(" expression  'then'  statement  statements-opt  make-statement-list  make-exp-then-statements ", a83.toString());

      ParseAction a84 = table.lookup("exp-then-stms", "'('");
      assertEquals(" expression  'then'  statement  statements-opt  make-statement-list  make-exp-then-statements ", a84.toString());

      ParseAction a85 = table.lookup("exp-then-stms", "'+'");
      assertEquals(" expression  'then'  statement  statements-opt  make-statement-list  make-exp-then-statements ", a85.toString());

      ParseAction a86 = table.lookup("exp-then-stms", "'-'");
      assertEquals(" expression  'then'  statement  statements-opt  make-statement-list  make-exp-then-statements ", a86.toString());

      ParseAction a87 = table.lookup("exp-then-stms", "'true'");
      assertEquals(" expression  'then'  statement  statements-opt  make-statement-list  make-exp-then-statements ", a87.toString());

      ParseAction a88 = table.lookup("exp-then-stms", "'false'");
      assertEquals(" expression  'then'  statement  statements-opt  make-statement-list  make-exp-then-statements ", a88.toString());

      ParseAction a89 = table.lookup("exp-then-stms", "string");
      assertEquals(" expression  'then'  statement  statements-opt  make-statement-list  make-exp-then-statements ", a89.toString());

      ParseAction a90 = table.lookup("exp-then-stms", "integer");
      assertEquals(" expression  'then'  statement  statements-opt  make-statement-list  make-exp-then-statements ", a90.toString());

      ParseAction a91 = table.lookup("exp-then-stms", "real");
      assertEquals(" expression  'then'  statement  statements-opt  make-statement-list  make-exp-then-statements ", a91.toString());

      ParseAction a92 = table.lookup("exp-then-stms", "'null'");
      assertEquals(" expression  'then'  statement  statements-opt  make-statement-list  make-exp-then-statements ", a92.toString());

      ParseAction a93 = table.lookup("exp-then-stms", "'boolean'");
      assertEquals(" expression  'then'  statement  statements-opt  make-statement-list  make-exp-then-statements ", a93.toString());

      ParseAction a94 = table.lookup("exp-then-stms", "'integer'");
      assertEquals(" expression  'then'  statement  statements-opt  make-statement-list  make-exp-then-statements ", a94.toString());

      ParseAction a95 = table.lookup("exp-then-stms", "'real'");
      assertEquals(" expression  'then'  statement  statements-opt  make-statement-list  make-exp-then-statements ", a95.toString());

      ParseAction a96 = table.lookup("exp-then-stms", "'string'");
      assertEquals(" expression  'then'  statement  statements-opt  make-statement-list  make-exp-then-statements ", a96.toString());

      ParseAction a97 = table.lookup("exp-then-stms", "'not'");
      assertEquals(" expression  'then'  statement  statements-opt  make-statement-list  make-exp-then-statements ", a97.toString());
      ...
      assertEquals(" identifier  make-id  identifiers-more-opt  make-id-list  ':'  typename  make-fp-section ", a190.toString());
      ...
      assertEquals(" identifier  make-id  make-formal-params-marker  formal-params  decl-typename-opt  body  ';'  make-proc-declaration ", a238.toString());
      ...
      assertEquals(" 'read'  make-read-marker  '('  lvalue  lvalues-more-opt  make-lvalue-list  ')'  ';'  make-read-statement ", a252.toString());
      ...
      assertEquals(" 'loop'  make-loop-marker  statement  statements-opt  make-statement-list  'end'  ';'  make-loop-statement ", a255.toString());

      ParseAction a256 = table.lookup("statement", "'for'");
      assertEquals(" 'for'  identifier  make-id  ':='  expression  'to'  expression  by-expression-opt  'do'  statements-opt  make-statement-list  'end'  ';'  make-for-statement ", a256.toString());

      ParseAction a257 = table.lookup("statement", "'if'");
      assertEquals(" 'if'  exp-then-stms  elseifs-opt  make-exp-then-statements-list  else-opt  'end'  ';'  make-if-statement ", a257.toString());
      ...
      assertEquals(" identifier  make-id  identifiers-more-opt  make-id-list  decl-typename-opt  ':='  expression  ';'  make-var-declaration ", a297.toString());
